...
*/
JNIEXPORT jint JNICALL Java_org_schabi_newpipe_pybridge_PyBridge_start
...
JNIEXPORT jint JNICALL Java_org_schabi_newpipe_pybridge_PyBridge_stop
...
*/
JNIEXPORT jstring JNICALL Java_org_schabi_newpipe_pybridge_PyBridge_call
